...
class UserRecordingSerializer(serializers.ModelSerializer):
    motion_name = serializers.CharField(source='motion_type.motion_name', read_only=True)
    user_name = serializers.CharField(source='user.name', read_only=True)

    class Meta:
        model = UserRecording
        fields = [
            "id", "user", "user_name", "motion_type", "motion_name", 
            "score", "recorded_at"
        ]
        read_only_fields = ["id", "recorded_at", "user_name", "motion_name"]
