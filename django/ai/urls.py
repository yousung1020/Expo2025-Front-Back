...
from .views import MotionRecordingView, UnifiedEvaluationView, MotionTypeViewSet, UserCourseRecordingView
...
urlpatterns = [
    ...
    path('recordings/user/<str:emp_no>/course/<int:course_id>/', UserCourseRecordingView.as_view(), name='user-course-recording'),
